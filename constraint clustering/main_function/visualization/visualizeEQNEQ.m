...
uncertaintyFileNEQ = [dataset, '-pt-new-RF-NEQNEW-', num2str(nq), '-', num2str(nps), '-uncertainty.data'];
consFileEQ = [dataset, '-pt-new-RF-EQNEW-', num2str(nq), '-', num2str(nps), '-constraints.data'];
consFileNEQ = [dataset, '-pt-new-RF-NEQNEW-', num2str(nq), '-', num2str(nps), '-constraints.data'];
...
resultFileNEQ = [dataset, '-pt-new-RF-NEQNEW-', num2str(nq), '-', num2str(nps), '.data'];
...
clusterFileNEQ = [dataset, '-pt-new-RF-NEQNEW-', num2str(nq), '-', num2str(nps), '-cluster.data'];
