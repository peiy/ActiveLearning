function [uncertainPointRaw,nPairs, neighbor, nq] = uncertain_query_mat(nq, neighbor, rawData, coassociation, flag1, flag2, dataset, num, nq_initial)
